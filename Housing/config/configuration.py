...
class Configuration:
    ...
    def get_data_ingestion_config(self) ->DataIngestionConfig:
        try:
            ...
            data_ingestion_config=DataIngestionConfig(dataset_download_url=dataset_download_url, tgz_download_dir=tgz_download_dir,
             raw_data_dir=raw_data_dir, ingested_train_dir=ingested_train_dir, 
    ...
    def get_data_transformation_config(self) ->DataTransformationConfig:
        try:
            artifact_dir=self.training_pipeline_config.artifact_dir
            data_transfromation_artifact_dir=os.path.join(artifact_dir,
            ...
            tranformed_dir=os.path.join(data_transfromation_artifact_dir,
            data_transformation_config[DATA_TRANSFORMATION_DIR_NAME_KEY])

            transformed_train_dir =os.path.join(tranformed_dir,
            data_transformation_config[DATA_TRANSFORMATION_TRAIN_DIR_NAME_KEY])

            transformed_test_dir=os.path.join(tranformed_dir,
            data_transformation_config[DATA_TRANSFORMATION_TEST_DIR_NAME_KEY])

            preprocessing_dir=os.path.join(data_transfromation_artifact_dir,
